...
var FullPage = /*#__PURE__*/function (_React$Component) {
  ...
  function FullPage(props) {
    ...
    _this.isScrollHappensInMainContainer = function (paths) {
    ...
    _this.onTouchMove = function (evt) {
      if (_this.props.scrollMode !== scrollMode.FULL_PAGE || !_this.isVerticalScrollIntent(evt.changedTouches[0]) || !_this.isScrollHappensInMainContainer(evt.path)) {
        return;
      }
      ...
      if (evt.path && evt.path.length) {
        var _iterator2 = _createForOfIteratorHelper(evt.path),
            _step2;
